...
public class StatementServiceTest extends OperationHistoryApiApplicationTest {
    ...
    public void saveOperationTest() {
        Operation operation1 = new Operation(1000, "RUB", "Место", 2);
        Operation operation2 = new Operation(900, "RUB", "Место", 3);
        ...
        List<Operation> expectedOperations = Arrays.asList(
                new Operation(1000, "RUB", "Место", 2),
                new Operation(900, "RUB", "Место", 3)
        );
